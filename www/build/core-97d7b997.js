...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_app('./css-shim-206ea950-3169f23e.js').then(() => {
...
export { Host as H, patchEsm as a, bootstrapLazy as b, getElement as c, createEvent as d, getContext as e, globals as g, h, patchBrowser as p, registerInstance as r };
